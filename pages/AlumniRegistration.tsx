...
const AlumniRegistration: React.FC = () => {
  ...
  const validateField = (name: string, value: string): string | undefined => {
    switch (name) {
      ...
      case "contactNumber":
        ...
        if (!/^[0-9]{10}$/.test(value.replace(/[^0-9]/g, "")))
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus("error");
      setErrorMessage(
        "Unable to connect to the mail server. Please check your internet connection.",
      );
    }
  };
      ...
      <div className="container mx-auto px-4 py-12 flex flex-col lg:flex-row gap-12">
        ...
        <div className="lg:w-3/4">
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 reveal-on-scroll">
            {status === "success" ? (
              <div
                className="p-12 text-center flex flex-col items-center justify-center h-full animate-fade-in"
                role="status"
                aria-live="polite"
              >
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-md">
                  Thank you for registering with IDEMI. Your details have been
                  recorded in our alumni database.
                </p>
                <button
                  onClick={() => {
                    setStatus("idle");
              ...
              <form onSubmit={handleSubmit} className="space-y-8" noValidate>
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Please fill in your details below. Fields marked with{" "}
                ...
                <div className="bg-gray-50 dark:bg-gray-700/20 p-6 rounded-lg border border-gray-100 dark:border-gray-600 space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        onBlur={handleBlur}
                        className={`w-full px-4 py-3 rounded-lg border ${formErrors.fullname ? "border-red-500 focus:ring-red-200" : "border-gray-300 dark:border-gray-600 focus:border-primary focus:ring-primary"} bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-4 outline-none transition uppercase`}
                        placeholder="SURNAME FIRSTNAME MIDDLENAME"
                      />
                      {formErrors.fullname && (
                        <p className="text-red-500 text-xs mt-1 error-message animate-fade-in">
                          {formErrors.fullname}
                        </p>
                      )}
                    </div>
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          onBlur={handleBlur}
                          className={`w-full pl-10 pr-4 py-3 rounded-lg border ${formErrors.rollNo ? "border-red-500 focus:ring-red-200" : "border-gray-300 dark:border-gray-600 focus:border-primary focus:ring-primary"} bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-4 outline-none transition`}
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">
                        SAMPARK REGISTRATION{" "}
                        <span className="text-red-500">*</span>
                      </label>
                      <select
                        name="samparkRegistration"
                        value={formData.samparkRegistration}
                        onChange={handleChange}
                        onBlur={handleBlur}
                        className={`w-full px-4 py-3 rounded-lg border ${formErrors.samparkRegistration ? "border-red-500 focus:ring-red-200" : "border-gray-300 dark:border-gray-600 focus:border-primary focus:ring-primary"} bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-4 outline-none transition`}
                      >
                        <option value="">Select Status</option>
                        <option value="DONE">DONE</option>
                        <option value="NOT DONE">NOT DONE</option>
                      </select>
                      {formErrors.samparkRegistration && (
                        <p className="text-red-500 text-xs mt-1 error-message animate-fade-in">
                          {formErrors.samparkRegistration}
                        </p>
                      )}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onBlur={handleBlur}
                          maxLength={10}
                          className={`w-full pl-10 pr-4 py-3 rounded-lg border ${formErrors.contactNumber ? "border-red-500 focus:ring-red-200" : "border-gray-300 dark:border-gray-600 focus:border-primary focus:ring-primary"} bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-4 outline-none transition`}
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        onBlur={handleBlur}
                        className={`w-full px-4 py-3 rounded-lg border ${formErrors.dob ? "border-red-500 focus:ring-red-200" : "border-gray-300 dark:border-gray-600 focus:border-primary focus:ring-primary"} bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-4 outline-none transition`}
                      />
                      {formErrors.dob && (
                        <p className="text-red-500 text-xs mt-1 error-message animate-fade-in">
                          {formErrors.dob}
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        onBlur={handleBlur}
                        className={`w-full px-4 py-3 rounded-lg border ${formErrors.category ? "border-red-500 focus:ring-red-200" : "border-gray-300 dark:border-gray-600 focus:border-primary focus:ring-primary"} bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-4 outline-none transition`}
                      >
                ...
                <div className="bg-gray-50 dark:bg-gray-700/20 p-6 rounded-lg border border-gray-100 dark:border-gray-600 space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g. BE Mechanical, Diploma in..."
                    />
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">
                        NAME OF COURSE COMPLETED FROM IDEMI{" "}
                        <span className="text-red-500">*</span>
                      </label>
                      <input
                        type="text"
                        ...
                        onChange={handleChange}
                        onBlur={handleBlur}
                        className={`w-full px-4 py-3 rounded-lg border ${formErrors.courseCompleted ? "border-red-500 focus:ring-red-200" : "border-gray-300 dark:border-gray-600 focus:border-primary focus:ring-primary"} bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-4 outline-none transition`}
                        placeholder="Course Name"
                      />
                      {formErrors.courseCompleted && (
                        <p className="text-red-500 text-xs mt-1 error-message animate-fade-in">
                          {formErrors.courseCompleted}
                        </p>
                      )}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={formData.passingMonthYear}
                        onChange={handleChange}
                        onBlur={handleBlur}
                        className={`w-full px-4 py-3 rounded-lg border ${formErrors.passingMonthYear ? "border-red-500 focus:ring-red-200" : "border-gray-300 dark:border-gray-600 focus:border-primary focus:ring-primary"} bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-4 outline-none transition`}
                      />
                      {formErrors.passingMonthYear && (
                        <p className="text-red-500 text-xs mt-1 error-message animate-fade-in">
                          {formErrors.passingMonthYear}
                        </p>
                      )}
                ...
                <div className="bg-gray-50 dark:bg-gray-700/20 p-6 rounded-lg border border-gray-100 dark:border-gray-600 space-y-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      onBlur={handleBlur}
                      className={`w-full px-4 py-3 rounded-lg border ${formErrors.currentStatus ? "border-red-500 focus:ring-red-200" : "border-gray-300 dark:border-gray-600 focus:border-primary focus:ring-primary"} bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-4 outline-none transition`}
                    >
                      <option value="">Select Status</option>
                      ...
                      <option value="I DON'T REQUIRE PLACEMENT FROM IDEMI">
                        I DON'T REQUIRE PLACEMENT FROM IDEMI
                      </option>
                    </select>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              onChange={handleChange}
                              className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary outline-none transition"
                        ...
                        {isSelfEmployment && (
                          <div>
                            ...
                            <input
                              ...
                              onChange={handleChange}
                              className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary outline-none transition"
                              placeholder="Udyam Reg No"
                            />
                          </div>
                        )}
                        {isWageEmployment && (
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              type="text"
                              name="higherEduCourse"
                              value={formData.higherEduCourse}
                              onChange={handleChange}
                              className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary outline-none transition"
                              placeholder="Course Name"
                            />
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={handleChange}
                            className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary outline-none transition"
                            placeholder="College City/Location"
                          />
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-3">
                        ARE YOU INTERESTED IN ANY OTHER COURSE IN IDEMI?{" "}
                        <span className="text-red-500">*</span>
                      </label>
                      <div className="flex gap-6">
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input
                            type="radio"
                            name="interestedInOtherCourses"
                            value="YES"
                            checked={
                              formData.interestedInOtherCourses === "YES"
                            }
                            onChange={handleChange}
                            onBlur={handleBlur}
                            className="accent-primary w-4 h-4"
                        ...
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input
                            ...
                            name="interestedInOtherCourses"
                            value="NO"
                            checked={formData.interestedInOtherCourses === "NO"}
                            onChange={handleChange}
                            onBlur={handleBlur}
                            className="accent-primary w-4 h-4"
                          />
                      ...
                      {formErrors.interestedInOtherCourses && (
                        <p className="text-red-500 text-xs mt-1 error-message animate-fade-in">
                          {formErrors.interestedInOtherCourses}
                        </p>
                      )}
                    ...
                    <div>
                      <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-3">
                        NEED PLACEMENT ASSISTANCE FROM IDEMI?{" "}
                        <span className="text-red-500">*</span>
                      </label>
                      <div className="flex gap-6">
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input
                            type="radio"
                            name="needPlacementAssistance"
                            value="YES"
                            checked={formData.needPlacementAssistance === "YES"}
                            onChange={handleChange}
                            onBlur={handleBlur}
                            className="accent-primary w-4 h-4"
                          />
                        ...
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input
                            ...
                            name="needPlacementAssistance"
                            value="NO"
                            checked={formData.needPlacementAssistance === "NO"}
                            onChange={handleChange}
                            onBlur={handleBlur}
                            className="accent-primary w-4 h-4"
                          />
                      ...
                      {formErrors.needPlacementAssistance && (
                        <p className="text-red-500 text-xs mt-1 error-message animate-fade-in">
                          {formErrors.needPlacementAssistance}
                        </p>
                      )}
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex justify-center md:justify-start">
                    ...
                    >
                      <div
                        className={`w-6 h-6 border-2 rounded-sm flex items-center justify-center transition-colors relative ${captchaVerified ? "border-green-500 bg-green-500" : "border-gray-400 bg-white"}`}
                      >
                  ...
                  {!captchaVerified && (
                    <p className="text-center md:text-left text-xs text-red-500 flex items-center gap-1 justify-center md:justify-start">
                      <AlertCircle size={12} /> Please complete the captcha
                      verification
                    </p>
                  )}
                </div>
