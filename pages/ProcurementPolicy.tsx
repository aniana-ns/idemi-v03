...
const DATA = [
    { id: 'p1', title: 'Procurement Policy 2024', date: '2024-01-01', size: '1.2 MB', link: 'https://idemi.org/assets/downloads/EC%20Blr%20Newspaper%20Ad%20A5%20Size.pdf', type: 'PDF' },
    { id: 'p2', title: 'General Financial Rules', date: '2023-06-15', size: '3.5 MB', link: 'https://idemi.org/assets/downloads/EC%20Blr%20Newspaper%20Ad%20A5%20Size.pdf', type: 'PDF' }
];

const ProcurementPolicy: React.FC = () => {
  useScrollAnimation();
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-950 min-h-screen transition-colors duration-200">
      <SEO 
        seo={{ 
          title: 'Procurement Policy | IDEMI', 
          description: 'Guidelines for procurement of goods and services.',
          keywords: ['Procurement Policy', 'Purchase Guidelines', 'General Financial Rules', 'GFR', 'Public Procurement'],
          schemaType: 'WebSite'
        }} 
        path="/downloads/procurement-policy" 
      />
      ...
      <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
        <div className="container mx-auto px-4 py-4">
             ...
             <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Procurement Policy</h1>
        </div>
      </div>
