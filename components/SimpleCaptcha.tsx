...
const SimpleCaptcha: React.FC<SimpleCaptchaProps> = ({ onVerify }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm w-full max-w-[320px] select-none">
      <div className="flex items-center justify-between mb-3">
        ...
        <button 
          ...
          className="text-gray-400 hover:text-primary dark:hover:text-blue-400 transition-colors p-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700"
          title="Get new code"
        >
          <RefreshCw size={14} />
        </button>
      ...
      <div className="flex items-center gap-3">
        <div className="flex-1 bg-gray-100 dark:bg-gray-700/50 h-10 rounded-lg border border-gray-200 dark:border-gray-600 flex items-center justify-center font-mono text-lg font-bold text-gray-700 dark:text-gray-200 tracking-widest relative overflow-hidden">
